...
export const OfficialDescriptorColumnDefData: ApiEnumTableEntry[] = [
  {
    field: 'LEGAL',
    description:
      'Information that relates to active or potential criminal or civil proceedings. If the information in question includes protected legal advice, use the LPP descriptor (see above) instead.',
  },
  {
    field: 'HR / MANAGEMENT',
    description:
